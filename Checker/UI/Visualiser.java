   ...
   implements ComponentListener, MouseListener, ChangeListener
 {
   ...
   public void updateSize(JViewport port)
   {
     ...
     setPreferredSize(new Dimension(this.viewPortWidth * this.zoom, 
   ...
   public void repaintBufferedImage()
   {
     if ((this.solution != null) && (this.viewPortHeight != 0) && (this.viewPortWidth != 0))
     {
       ...
       if (this.image == null)
       {
         this.image = new BufferedImage(this.viewPortWidth * this.zoom, this.viewPortHeight * this.zoom, 
           1);
       }
       else if ((this.image.getHeight() != this.viewPortHeight * this.zoom) || (this.image.getWidth() != this.viewPortWidth * this.zoom))
       {
         this.image = new BufferedImage(this.viewPortWidth * this.zoom, this.viewPortHeight * this.zoom, 
           1);
