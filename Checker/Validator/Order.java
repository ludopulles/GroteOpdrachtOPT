 ...
 public class Order
 {
   ...
   public boolean isValid(WarningCollector warnings)
   {
     ...
     for (int i = 0; i < 5; i++)
     {
       ...
       case 1:  count++;
         break;
       default:  warnings.addWarning("!!! Order " + this.id + " is planned " + this.orderCountDay[i] + " times on " + getDay(i));
         return false;
       }
     ...
     else
     {
       ...
       case 2: 
         ...
         break;
       case 3:  if (this.orderCountDay[0] + this.orderCountDay[2] + this.orderCountDay[4] != 3)
         {
           warnings.addWarning("!!! Order " + this.id + " isn't planned on the correct days.\n" + 
             "       planned on: " + getDaysPlanned() + "\n" + 
